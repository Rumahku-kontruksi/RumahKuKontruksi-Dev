// client/src/pages/admin/LaporanPengawas.jsx
...
const LaporanPengawas = () => {
  ...
  const [laporan] = useState([
    {
      ...
      deskripsi:
        "Pengecekan struktur dinding dan atap. Semua sesuai standar keamanan.",
      file: "laporan-pengawas-budi.pdf",
    },
    {
      id: 2,
      tanggal: "2025-10-10",
      ...
      deskripsi:
        "Kualitas material bata dan semen sudah diperiksa dan layak pakai.",
      file: "laporan-pengawas-sinta.pdf",
    },
    {
      id: 3,
      tanggal: "2025-10-09",
      proyek: "Kantor CV. Maju Jaya",
      deskripsi:
        "Kedisiplinan pekerja dan keselamatan kerja berjalan baik tanpa pelanggaran.",
      file: "laporan-pengawas-majujaya.pdf",
    },
  ]);
  ...
  const handleCetakPDF = () => {
    const doc = new jsPDF();
    doc.setFontSize(14);
    doc.text("Laporan Pengawas RumahKuKonstruksi", 14, 15);
    doc.setFontSize(11);
    doc.text(
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      >
        <h1 className="text-3xl font-bold text-teal-700 flex justify-center items-center gap-2">
          <HiClipboardCheck className="text-4xl" /> Laporan Pengawas
        </h1>
        <p className="text-gray-600 mt-2">
          Catatan dan hasil pengawasan kualitas serta keselamatan proyek.
        </p>
      </motion.div>
      ...
      <p className="text-center text-gray-500 mt-8 text-sm">
        © 2025 RumahKuKonstruksi — Sistem Laporan Pengawas
      </p>
    </div>
  );
};

export default LaporanPengawas;
