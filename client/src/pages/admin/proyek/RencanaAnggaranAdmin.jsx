...
const RencanaAnggaranAdmin = () => {
  ...
  const handleTambahRAB = () => {
    alert("Fitur tambah RAB akan ditambahkan selanjutnya 🚧");
  };

  const handleExportPDF = (rab) => {
    alert(`Export PDF untuk ${rab.namaProyek} sedang dalam pengembangan 🧾`);
  };

  const handleHapus = (id) => {
    setDataRAB(dataRAB.filter((rab) => rab.id !== id));
  };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white w-[90%] md:w-[700px] rounded-xl shadow-lg p-6 relative">
            ...
            <p className="text-gray-600 mb-3">
              Konsumen:{" "}
              <span className="font-medium">{selectedRAB.konsumen}</span>
            </p>
...
export default RencanaAnggaranAdmin;
